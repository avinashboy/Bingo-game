...
socket.on("swin", data => {
  $('#show').append(`<li>${data} he got bingo..!</li>`)
  })
...
function checkMe() {
  if (countStrike === 1) {
    document.getElementById('iob').classList.add("done_color")
  }
  if (countStrike === 2) {
    document.getElementById('ioi').classList.add("done_color")
  }
  if (countStrike === 3) {
    document.getElementById('ion').classList.add("done_color")
  }
  if (countStrike === 4) {
    document.getElementById('iog').classList.add("done_color")
  }
  if (countStrike === 5) {
    document.getElementById('ioo').classList.add("done_color")
  }
}
